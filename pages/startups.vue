        ...
        <form class="d-flex justify-content-between">
          <div class="info">
            ...
            <div class="own">
              ...
              <div class="text-info">{{ activeStartup.owner }}</div>
            </div>
    ...
    async getStartup(id) {
      try {
        this.activeStartup = await this.$axios.$get(
          `https://monzun-admin.herokuapp.com/api/startups/${this.$route.query.id}`
        );
        console.log(this.activeStartup); // если все хорошо удалить
